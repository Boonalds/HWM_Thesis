...
%% Results
\newpage
\section{Material and Methods}  % Results

\subsection{Performance albedo map} % RQ 1

\subsection{Performance albedo map} % RQ 2

\subsection{Performance albedo map} % RQ 3

\subsection{Performance albedo map} % RQ 4
